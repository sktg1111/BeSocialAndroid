...
EditText etName;
    ...
    public void buLogin(View view) {
        ...
        StorageReference storageRef = storage.getReferenceFromUrl("gs://social-app-f69e8.appspot.com");
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                String url="http://10.0.2.2/practice/server/register.php?first_name="+name+"&email="+etEmail.getText().toString()+"&password="+etPassword.getText().toString()+"&picture_path="+ downloadUrl;
...
//login
                    String url="http://10.0.2.2/practice/server/login.php?email="+etEmail.getText().toString()+"&password="+etPassword.getText().toString() ;
